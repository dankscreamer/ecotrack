    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-100 p-4 dark:from-slate-950 dark:to-slate-900">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-slate-500 dark:text-slate-400">Join the movement for a greener future</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`glass-input w-full rounded-xl py-2.5 pl-10 pr-4 text-slate-900 placeholder-slate-400 dark:text-white ${errors.name ? 'border-red-500 focus:ring-red-500/50' : ''}`}
